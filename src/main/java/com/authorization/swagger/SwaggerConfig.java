package com.authorization.swagger;
...
public class SwaggerConfig {
	...
	private static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Authorization Microservice",
			...
			"1.0", "can be accessed only from an registered Client aplpication", DEFAULT_CONTACT,
